...
| 7 | Airplane-mode acceptance gate + instrumentation + polish | in progress — pre-gate tracks `6f-deploy` (`7ed9f15`) and `6g-warmups` (`dbb27db`) done first, so the gate tests a deployable build and the shipped content. |
